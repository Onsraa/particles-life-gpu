...
pub fn setup_viewports(
    ...
    for sim_id in 0..sim_config.num_simulations {
        let row = sim_id / sim_config.viewport_cols;
        let col = sim_id % sim_config.viewport_cols;
        ...
        commands.spawn((
            ...
            SimulationCamera { simulation_id: sim_id },
...
pub fn update_viewports_on_resize(
    ...
    for event in resize_events.read() {
        ...
        for (mut camera, sim_camera) in cameras.iter_mut() {
            let sim_id = sim_camera.simulation_id;
            let row = sim_id / sim_config.viewport_cols;
            let col = sim_id % sim_config.viewport_cols;
